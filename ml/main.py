...
def ml_celular():
    if request.method == 'POST':
        ...
        conversacion=request.form['conversacion']
        camaraP=request.form['camaraP']
        camaraS=request.form['camaraS']
        alto_Resol=request.form['alto_Resol']
        ancho_Resol=request.form['ancho_Resol']
        altura_Pant=request.form['altura_Pant']
        ancho_Pant=request.form['ancho_Pant']
        profundidad=request.form['profundidad']
        peso=request.form['peso']

        sim=request.form.getlist('sim')
        tec4g=request.form.getlist('tec4g')
        tec3g=request.form.getlist('tec3g')
        pantalla=request.form.getlist('pantalla')
        bluetooth=request.form.getlist('bluetooth')
        wifi=request.form.getlist('wifi')
        ...
        x_new_celular=[[int(bateria),int(bluetooth),float(reloj),
                        int(sim),int(camaraS),int(tec4g),int(rom),
                        float(profundidad),float(peso),int(nucleos),
                        int(camaraP),int(alto_Resol),int(ancho_Resol),
                        int(ram),float(altura_Pant),float(ancho_Pant),int(conversacion),
                        int(tec3g),int(pantalla),int(wifi)
        ...
        return render_template('consulta_Celular.html',
                               accuracyKNN=accuracyKNN,
                               resultadoknn=resultadoknn,
                               accuracyRF=accuracyRF,
                               resultadoRF=resultadoRF,
